...
% animate pendulum ads a function of angle and position
% thetaIn is pendulum angle
% xIn is pendulum position
% L is pendulum length
% t is the time array
% kickFlag is true when a kick pertubation is applied at that timeframe
